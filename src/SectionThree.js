        ...
        <div class="container h-100">
          <div class="row h-100 ">
            <div class="col-12 text-center upper-img mt-5">
              <h1 class="fw-bolder text-dark mt-5">Trade with Confidence. Trade WalletX.</h1>
              <p class="lead text-dark mb-5 ">
              Secure, safe and for a normal price.              </p>
              ...
              <table>
                <tbody>
                  <tr class="row100 body">
                    ...
                    <td class="cell100 column4"><div class="btn-group">
    <button type="button" class="btn btn-success mx-2 px-5">Sell</button>
    <button type="button" class="btn btn-primary mx-2 px-5">Buy</button>
</div></td>
                  </tr>
