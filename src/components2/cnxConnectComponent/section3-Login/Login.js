...
import register from "../../../assests2/images/cnx-connect/register-icon.svg";
import auth from "../../../assests2/images/cnx-connect/auth-icon.svg";
import access from "../../../assests2/images/cnx-connect/access-icon.svg";
const Login = () => {
  return (
