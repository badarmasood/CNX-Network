...
import download from "../../../assests2/images/vpn/download.svg";
import account from "../../../assests2/images/vpn/account.svg";
import network from "../../../assests2/images/vpn/network.svg";
const Join = () => {
  return (
