...
import btc from "../../../assests2/images/walletx/btc.png";
import cnx from "../../../assests2/images/walletx/cnx.png";
import eth from "../../../assests2/images/walletx/eth.png";
import ada from "../../../assests2/images/walletx/ada.png";
const Trade = () => {
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            ...
            <div
              className="table-responsive aos-init"
              data-aos="fade-up"
              data-aos-delay="100"
            >
