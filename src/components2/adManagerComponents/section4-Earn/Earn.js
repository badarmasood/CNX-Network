...
import globe from "../../../assests2/images/manager/globe.svg";
import graph from "../../../assests2/images/manager/graph.svg";
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="platform-content-wraper">
              <div
                className="platform-content aos-init"
                data-aos="fade-up"
                data-aos-delay="100"
              >
                <h2>High</h2>
