...
import monetise from "../../../assests2/images/manager/monetise-circle-img.svg";
import monetise1 from "../../../assests2/images/manager/monetise-shape-img.svg";
import monetise2 from "../../../assests2/images/manager/monetise-icon-1.svg";
import monetise3 from "../../../assests2/images/manager/monetise-icon-2.svg";
import monetise4 from "../../../assests2/images/manager/monetise-icon-3.svg";
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-4">
            <div
              className="monetise-wrap aos-init"
              data-aos="fade-up"
              data-aos-delay="100"
            >
