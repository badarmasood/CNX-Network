...
import way1 from "../../../assests2/images/manager/way-shape-1.svg";
import way2 from "../../../assests2/images/manager/way-shape-2.svg";
import mobile1 from "../../../assests2/images/manager/mobile-icon-1.svg";
import mobile2 from "../../../assests2/images/manager/mobile-icon-2.svg";
import mobile3 from "../../../assests2/images/manager/mobile-icon-3.svg";
import mobile4 from "../../../assests2/images/manager/mobile-icon-4.svg";
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-3">
            <div
              className="way-content aos-init"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <img src={mobile1} alt="" />
